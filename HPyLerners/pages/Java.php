...
<body>
	...
	?>
		...
		<div class="plang_header container">
			...
			<b><p><u>Welcome to our Basic java tutorial</u></p></b>
		</div>
		...
		<div class="plang_body1 container">
			...
			<div class="vid_show_vid row">
				<?php 
				 ...
				 ?>
				<iframe src="https://www.youtube.com/embed/hf4k4OWlBfI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div>
			<div class=" row">
				<div class="vid_show col-md-6">
					<h3>Java Bangla Tutorials 1 : Introduction to Java</h3>
				</div>
