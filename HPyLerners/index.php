		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
			  <li class="nav-item active">
				<a class="nav-link font2" href="pages/frist.php">&#x1F3E0;Home<span class="sr-only">(current)</span></a>
			  </li>
			  <li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle font2" href="pages/frist.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Courses</a>
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				  <a class="dropdown-item" href="pages/frist.php">Python</a>
				  <a class="dropdown-item" href="pages/frist.php">Java</a>
				  <a class="dropdown-item" href="pages/frist.php">JavaScript</a>
				  <a class="dropdown-item" href="pages/frist.php">PHP</a>
			  ...
			  <li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				  <a class="dropdown-item" href="pages/frist.php">Data Science</a>
				  <a class="dropdown-item" href="pages/frist.php">Mechine learning</a>
				  <a class="dropdown-item" href="pages/frist.php">OpenCV</a>
				  <div class="dropdown-divider"></div>
				  <a class="dropdown-item" href="pages/frist.php">Projects</a>
				</div>
			  </li>
			  <li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle font2" href="pages/frist.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				  Framework
				</a>
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				  <a class="dropdown-item" href="pages/frist.php">Tkinter</a>
				  <a class="dropdown-item" href="pages/frist.php">PyQT5</a>
				  <a class="dropdown-item" href="pages/frist.php">Django</a>
				  <a class="dropdown-item" href="pages/frist.php">Flask</a>
				  <a class="dropdown-item" href="pages/frist.php">Java swing</a>
				  <a class="dropdown-item" href="pages/frist.php">Java FX</a>
				  <div class="dropdown-divider"></div>
				  <a class="dropdown-item" href="">Projects</a>
				</div>
			  </li>
			  <li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle font2" href="pages/frist.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Help</a>
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				  <a class="dropdown-item" href="pages/frist.php">FAQ</a>
				  <a class="dropdown-item" href="pages/frist.php">About</a>
				</div>
			  </li>
			  <li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle font2" href="pages/frist.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				...
				<div class="index_profile dropdown-menu" aria-labelledby="navbarDropdown">
				  <a href="pages/frist.php" class="dropdown-item"><img src="images/user.png" class="bd_img_round" alt=""></img>My Profile</a>
				  
				  <div class="index_profile dropdown-divider"></div>
				  <a href="pages/frist.php" class="dropdown-item"><img src="images/logout.jpg" class="bd_img_round" alt="" />Logout</a>
				</div>
			  </li>
			</ul>
...
<div class="container">
	...
	<div class="container">
		...
		<div class="right-col col-3"> <!-- right col  -->
			...
			<div class="index_ad1">
				...
				<p>Amazing graphical user interface. Easy to design & works properly. Lorem ipsum dolor sit amet, consectetuer adipiscing elitdewwe. <a href="#">See demo</a></p>
			</div>
			
			<div class="index_ad2">
				<img src="images/django_site.png" alt="" />
				<h3>Web development with Python</h3>
				<p>Django is on way! It is very nice feature of python. Make your website with python programming. Lorem ipsum dolor sit amet, consectetuer adipiscing elitunasdh <a href="#">See demo</a></p>
			</div>
			...
			<img src="images/face_recog.jpg" alt="" />
				...
				<p>Awesome project, as you can use it for class attedendence. Something like digital classroom. <a href="#">See demo</a></p>
			</div>
	...
	<div class="footer container-fluid">
		<p>&copy;	<p>&copy; All rights reserved by codelearns</p></p>
	</div>
	</footer>
...
<?php  
	...
	if (isset($_POST['Query_submit1'])) {
		$u_name = $_POST['index_query_name1'];
		$user_email = $_POST['index_query_email1'];
		$user_phone = $_POST['index_query_phone1'];
		$user_qurey = $_POST['index_query_query1'];
		$Membership = '';
