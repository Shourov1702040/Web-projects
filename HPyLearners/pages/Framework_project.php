...
<body>
	...
	?>
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
			  ...
			  <li class="nav-item dropdown active">
				<a class="nav-link dropdown-toggle font2" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Java</a>
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				  <a class="dropdown-item" href="java.php">Basic</a>
				  <a class="dropdown-item" href="#">Advanced</a>
				  <a class="dropdown-item" href="#">Projects</a>
				  <div class="dropdown-divider"></div>
				  <a class="dropdown-item" href="IDE_java.php">Online IDE</a>
		...
		<div class="plang_header container">
			<h1>Framework projects</h1>
			<b><p><u>Welcome to our framework project tutorial</u></p></b>
		</div>
			
		<div class="plang_top1_body container-fluid">
		...
		<div class="plang_body1 container">
			...
			<div class="vid_show_vid row">
				<?php 
				 ...
				 ?>
				<iframe src="https://www.youtube.com/embed/hf4k4OWl34BfI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div>
			<div class=" row">
				<div class="vid_show col-md-6">
					<h3>Framework project Tutorials 1 : Introduction to GUI</h3>
				</div>
