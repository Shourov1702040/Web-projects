...
<body>
	...
	?>
		...
		<img src="../images/1200px-Python-logo-notext.svg.png" class="logo_class" alt="" />
		  <abbr title="HSTU Python Learners"><a class="navbar-brand font1 title_pad" href="home.php">HPyLe@rners.org</a></abbr>
		...
		<div class="pp_top_body container">
			<h1 id="about_main_head">About our Team</h1>
		</div>
		<div class="about_div1 container-fluid">
		
		</div>
		<div class="container"> 
			<h2 class="about_head">Gourp-12</h2>
			<h4 class="about_head1">Department of CSE | HSTU</h4>
			<h4 class="about_head2">Members:</h4>
			
			<div class="member bd_top row">
				<div class="img_part col-3">
					<img src="../images/person/m2.jpg" alt="" />
				</div>
				<div class="decs_m col-7">
					<h2>Touhid Islam Shourov</h2>
					<p>Student of department of CSE </br> 
					Level-3, Semester-II </br>
					@ Hajee Mohammad danesh Science and Technology University, Dinajpur</br>
					<span>&#9742;</span>&emsp;+880 1987128</br>
					<span>&#x2709;</span>&emsp;shourovhstu17@gmail.com</br>
					<a href="#"><img src="../images/facebook.png" alt="" /> &ensp;Shourov</a>
					</p>
				</div>
			</div>
			...
			<div class="member row">
				...
				<div class="img_part col-3">
					<img src="../images/person/fera2.jpg" alt="" />
				</div>
				<div class="decs_m col-7">
					<h2>Farah Sultana Fera</h2>
					<p>Student of department of CSE </br> 
					Level-3, Semester-II </br>
					@ Hajee Mohammad danesh Science and Technology University, Dinajpur</br>
					<span>&#9742;</span>&emsp;+880 1987128</br>
					<span>&#x2709;</span>&emsp;farahsultanafera@gmail.com</br>
					<a href="#"><img src="../images/facebook.png" alt="" /> &ensp;Farah Sultana Fera</a>
					</p>
			...
			<div class="member row">
				<div class="img_part col-3">
					<img src="../images/person/rakibul.jpg" alt="" />
				</div>
				<div class="decs_m col-7">
					<h2>Rakibul Hasan Dipu</h2>
					<p>Student of department of CSE </br> 
					Level-3, Semester-II </br>
					@ Hajee Mohammad danesh Science and Technology University, Dinajpur</br>
					<span>&#9742;</span>&emsp;+880 1756356523</br>
					<span>&#x2709;</span>&emsp;mdrakibulhasan@gmail.com</br>
					<a href="#"><img src="../images/facebook.png" alt="" /> &ensp;Rakibul</a>
					</p>
	...
	<div class="footer container-fluid">
		<p>&copy; All rights received by dept. of CSE, HSTU</p>
	</div>
	</footer>
